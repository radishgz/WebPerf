...
public abstract class AbstractPageCheck extends DefaultNodeVisitor {
  ...
  protected final void createViolation(int linePosition, String message,Node node) {
	   createViolation(linePosition,message,node,"");
	  }

  protected final void createViolation(int linePosition, String message,Node node,String subRule) {
    WebViolation violation = WebViolation.WebCreate(rule,
    		getWebSourceCode().getResource(),node,subRule);
