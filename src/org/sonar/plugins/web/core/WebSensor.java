...
public final class WebSensor implements Sensor {
  ...
  public WebSensor(Web web, RulesProfile profile, NoSonarFilter noSonarFilter) {
    ...
    //create check class list 
    //check class define in CheckClasses 
  ...
  public void analyse(Project project, SensorContext sensorContext) {
    ...
    final HtmlAstScanner scanner = setupScanner(project);
 ...
 * @param project 
   */
  private HtmlAstScanner setupScanner(Project project) {
    HtmlAstScanner scanner = new HtmlAstScanner(project,ImmutableList.of(new PageCountLines(), new ComplexityVisitor(), new NoSonarScanner(noSonarFilter)));
